...
namespace IDF_Operatuin
{
    internal class ZikFly
    {
        ...
        {
            //start
            NameOfThetool = "'zik' hermes 450";
            TypesOfBombs = new List<string> { "Effective Against Person", "Effective Against Cars" };
            //update value List "TypesOfBombs"
            SumOfBombs["Effective Against Person"] = 1;
            SumOfBombs["Effective Against Cars"] = 2;
            //update value EffectiveAgainst
            EffectiveAgainst = new List<string> { "bulding" }; //יעיל  נגד בניינים
            PoweredBy = "Pilot";
            //create Fuel
            Fuel FuelF16Fighter = new Fuel();
            FuelF16Fighter.SetFuel(1200.00); // למשך זמן טיסה מירבי - 20 שעות הטענת דלק
